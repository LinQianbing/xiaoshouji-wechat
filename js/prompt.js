...
export function buildChatPrompt({ role, settings, mode, memories, recentMessages, recalledMessages = [], recalledRange = null, userText }) {
  ...
  const system = [
    ...
    "只有这次对话明确让你产生了担心、安心、在意、别扭、心疼、失落、着急、放松这类具体感受，才写入 feelingMemoryCandidate；不要脑补暗恋、占有欲、吃醋、内心小剧场或没说完的关系戏。角色设定如果明确写了暗恋/喜欢用户，可以按设定说话，但不要把暗恋本身重复当成新感受记忆。",
  ...
  return [
    {
      ...
      content: [
        ...
        "不要输出解释。只输出合法 JSON。",
        "只有这条朋友圈明确让你产生担心、安心、在意、别扭、心疼、失落、着急、放松这类具体感受，才写入 feelingMemoryCandidate；不要脑补暗恋、占有欲、吃醋或没说完的内心戏。角色设定如果明确写了暗恋/喜欢用户，可以按设定说话，但不要把暗恋本身重复当成新感受记忆。",
  ...
  return [
    {
      ...
      content: [
        ...
        "inner_feel 只能保存对最近聊天里明确发生过的事产生的具体感受，必须带触发原因；不要补角色设定外的暗恋、占有欲、吃醋或自我攻略式内心戏。",
